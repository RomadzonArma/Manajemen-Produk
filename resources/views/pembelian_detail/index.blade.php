        ...
        <div class="col-lg-12">
            <div class="box">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('pembelian.store') }}" method="post" class="form-pembelian">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="diskon" name="diskon" class="form-control" value="{{ $diskon }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <div class="box-footer">
                    <button class="btn btn-primary btn-flat btn-simpan"><i class="fa fa-floppy-o"></i> Simpan Transaksi</button>
                </div>
            </div>
        </div>
    </div>
